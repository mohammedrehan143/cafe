...
CREATE TABLE IF NOT EXISTS public.admin_keys (
    ...
    key_value TEXT NOT NULL,                   -- e.g. '9019631104' or custom PIN
...
-- 2. Insert Initial 2 Keys
-- Key 1: Universal Master Recovery Key (9019631104)
INSERT INTO public.admin_keys (id, key_name, key_value, key_hash, is_universal, updated_at)
VALUES (
    'universal',
    'universal_master_key',
    '9019631104',
    '9019631104',
    TRUE,
    NOW()
...
SET key_value = '9019631104', is_universal = TRUE, updated_at = NOW();
